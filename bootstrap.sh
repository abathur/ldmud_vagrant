...
sudo apt-get install -q -y -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" screen curl git libxml2
sudo su
...
apt-get install -q -y -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" mysql-server-5.1 mysql-server mysql-client php5-cli php-pear php5-mysql libmysqlclient-dev php5-curl redis-server nginx autoconf libtool flex bison gdb varnish libaprutil1-dev apache2.2-common shtool php5-dev apache2-prefork-dev
